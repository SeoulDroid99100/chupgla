...
LEAGUES = [  
    {"min": 1.0, "max": 5.0, "name": "Grunt 🌱", "reward": 100},  
    {"min": 5.1, "max": 10.0, "name": "Brute 🏗️", "reward": 250},  
    {"min": 10.1, "max": 20.0, "name": "Savage ⚔️", "reward": 500},  
    {"min": 20.1, "max": 35.0, "name": "Warlord 🐺", "reward": 1000},  
    {"min": 35.1, "max": 50.0, "name": "Overlord 👑", "reward": 2000},  
    {"min": 50.1, "max": 75.0, "name": "Tyrant 🛡️", "reward": 3500},  
    {"min": 75.1, "max": 100.0, "name": "Behemoth 💎", "reward": 5000},  
    {"min": 100.1, "max": 150.0, "name": "Colossus 🔥", "reward": 7500},  
    {"min": 150.1, "max": float('inf'), "name": "Godhand ✨", "reward": 10000}  
]  
